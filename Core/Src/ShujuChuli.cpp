...
#define STARTADDR (0x800000-FFF*1024*8)
void ShujuChuli::cx_in2Flash(u8 *p) {//写512K
	for(int i=0;i<FFF*2;i++)
		OW25Qxx::EraseSector(STARTADDR+i*4096);
	for(int i=0;i<FFF*4*8;i++)//页编程
		OW25Qxx::WriteBuffer(p+i*256, STARTADDR+i*256, 256);
